...
<Tabs>
  ...
  <ol>
    ...
    <li>If the switch is not active, tap on the switch.</li>
    <li>Tap on <b>Continue</b> if you want to enable taking screenshots or <b>Cancel</b> to abort.</li>
  </ol>
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <ol>
    <li>Tap on <b>Screenshots</b>.</li>
    <li>If the switch is active, tap on the switch.</li>
  </ol>
  </TabItem>
</Tabs>
