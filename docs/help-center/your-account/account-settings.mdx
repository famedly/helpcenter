...
<Tabs>
  ...
  <ol>
    ...
    <li>Click on <b>Open gallery</b>.</li>
  ...
  <ol>
    ...
    <li>Tap on <b>Open gallery</b> or <b>Open camera</b>.</li>
    <li>Choose a photo from your gallery, or snap a new one with the camera.</li>
  </ol>
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <ol>
    ...
    <li>Click on <b>Profile</b>.</li>
    <li>Click on the profile picture or name initials.</li>
    <li>Click on <b>Remove avatar</b>.</li>
  </ol>
  </TabItem>
  <TabItem value="mobile" label="Mobile">
  <ol>
    ...
    <li>Tap on <b>Profile</b>.</li>
    <li>Tap on the profile picture or name initials.</li>
    <li>Tap on <b>Remove avatar</b>.</li>
  </ol>
  </TabItem>
</Tabs>

## Setup a status message
...
<Tabs>
  ...
  <ol>
    <li>To access the settings, click on your profile picture or name initials.</li>
    <li>Click on <b>Profile</b>.</li>
    <li>Click on <b>Add status</b>.</li>
    <li>Type your status message into the input field.</li>
  ...
  <ol>
    <li>To access the settings, tap on your profile picture or name initials.</li>
    <li>Tap on <b>Profile</b>.</li>
    <li>Tap on <b>Add status</b>.</li>
    <li>Type your status message into the input field.</li>
    <li>Tap on <b>Continue</b>.</li>
  </ol>
  </TabItem>
</Tabs>
...
Just repeat the steps to setup a status message and change the status in the input field.

### Remove your status message
...
<Tabs>
  ...
  <ol>
    <li>To access the settings, click on your profile picture or name initials.</li>
    <li>Click on <b>Profile</b>.</li>
    <li>Click on the <b>X</b>-Button in the status message box.</li>
  </ol>
  </TabItem>
  <TabItem value="mobile" label="Mobile">
  <ol>
    <li>To access the settings, tap on your profile picture or name initials.</li>
    <li>Tap on <b>Profile</b>.</li>
    <li>Tap on the <b>X</b>-Button in the status message box.</li>
  </ol>
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <ol>
    ...
    <li>Flip the switch to enable or disable the notifications for your whole account.</li>
  </ol>
  </TabItem>
  <TabItem value="mobile" label="Mobile">
  <ol>
    <li>To access the settings, tap on your profile picture or name initials.</li>
    <li>Tap on the <b>Notifications</b> field.</li>
    <li>Flip the switch to enable or disable the notifications for your whole account.</li>
  </ol>
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <ol>
    <li>To access the settings, click on your profile picture or name initials.</li>
    <li>Tap on <b>Security</b>.</li>
    <li>Tap on <b>Screen lock</b> to enter screen lock settings.</li>
    <li>There tap on <b>Screen lock</b> again to activate the switch.</li>
...
On Android devices, you can enable or disable the ability to take screenshots. By default, it is disabled.  
On iOS taking screenshots is enabled by default and will only give you a warning every time you take a screenshot
therefore you will only find this setting on Android. 

### Enable or disable taking screenshots

Please be careful with sensitive data. Preferably do not take screenshots of chats since that might leak sensitive data. 
If you have to take a screenshot that might contain sensitive data, please delete it from your device when you do not
need it anymore. Only share screenshots that contain personal data with people who are allowed to receive this data.  

<Tabs>
  <TabItem value="android" label="Android">
  <ol>
    <li>To access the settings, tap on your profile picture or name initials.</li>
    <li>Tap on <b>Screenshots</b>.</li>
    <li>Flip the switch.</li>
    <li>If you want to enable taking screenshots, you will be prompted to confirm the choice.</li> 
    <li>For enabling taking screenshots, tap on <b>Continue</b>.</li>
  </ol>
  </TabItem>
</Tabs>
...
Here you have options to choose if you want to share read receipts, typing indicators or your [online status](../using-famedly/chats#check-the-status-of-users) with others and if you want to share crash reports with Famedly to help us enhance the app. 
...
Other users that have an up-to-date version of Famedly will be able to see if you are online when you activate the toggle for sending the [online status](../using-famedly/chats#check-the-status-of-users).
...
<Tabs>
  ...
  <ol>
    <li>To access the settings, click on your profile picture or name initials.</li>
    <li>Click on <b>Security</b>.</li>
    <li>Click on <b>Data privacy</b>.</li>
...
In this section you can find instructions on how to alter the behaviour of the Enter key.

:::info
This setting can be made individually for each device and is reset to the default setting when you log out through the profile settings or remove the device in devices settings. You will have to set it again after login.
:::
...
<Tabs>
  ...
  <ol>
    <li>To access the settings, click on your profile picture or name initials.</li>
    <li>Click on <b>Chat settings</b>.</li>
    <li>By default, pressing Enter will send a message.</li>
    <li>If you want to start a new line by pressing Enter, click on <b>Start new line</b> option.</li>
    <li>If you want to send a message by pressing Enter, click on <b>Send message</b> option.</li>
  </ol>
  </TabItem>
  <TabItem value="mobile" label="Mobile">
  <ol>
    <li>To access the settings, tap on your profile picture or name initials.</li>
    <li>Tap on <b>Chat settings</b>.</li>
    <li>By default, tapping Enter will start a new line.</li>
    <li>If you want to start a new line by tapping Enter, tap on <b>Start new line</b> option.</li>
    <li>If you want to send a message by tapping Enter, tap on <b>Send message</b> option.</li>
  </ol>
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <ol>
    <li>To access the settings, click on your profile picture or name initials.</li>
    <li>Click on <b>Profile</b>.</li>
    <li>Click on <b>Log out</b> below your profile picture.</li>
    <li>Confirm the sign out by clicking <b>Log out</b>.</li>
  </ol>
  </TabItem>
  <TabItem value="mobile" label="Mobile">
  <ol>
    <li>To access the settings, tap on your profile picture or name initials.</li>
    <li>Tap on <b>Profile</b>.</li>
    <li>Tap on <b>Log out</b> below your profile picture.</li>
    <li>Confirm the sign out by tapping <b>Log out</b>.</li>
  </ol>
  </TabItem>
</Tabs>
