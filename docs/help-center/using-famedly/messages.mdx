...
## Jump to a replied message

If there is a replied message you can jump to the referenced message by clicking the message. This feature works on web and on the mobile app.