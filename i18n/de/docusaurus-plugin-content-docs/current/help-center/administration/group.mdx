...
Erstellen Sie eine neue Gruppe innerhalb Ihrer Organisation.
...
Löschen Sie eine Gruppe, die Sie nicht mehr benötigen.

<Tabs>
  <TabItem value="desktop" label="Desktop" default>
  <ol>
    <li>Gehen Sie zum Bereich <b>Gruppen</b>.</li>
    <li>Finden Sie die Gruppe und wählen Sie <b>Löschen</b> unter <b>Aktionen</b>.</li>
    <li>Bestätigen Sie die Pop-up-Benachrichtigung.</li>
  </ol>
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem value="desktop" label="Desktop" default>
  <ol>
    <li>Zuerst müssen Sie die Untergruppe als reguläre Gruppe hinzufügen.</li>
    <li>Gehen Sie dann in die Gruppe, zu der Sie die Untergruppe hinzufügen möchten.</li>
    <li>Klicken Sie auf den Abschnitt <b>Untergruppe</b></li>
    <li>Klicken Sie auf <b>+ Untergruppe hinzufügen</b>.</li>
    <li>Finden Sie die Gruppe, die Sie als Untergruppe hinzufügen möchten, und wählen Sie <b>Hinzufügen</b>.</li>
  </ol>
  </TabItem>
</Tabs>
...
Sie können Pflichträume für Benutzer innerhalb einer Gruppe erstellen. Benutzer können den Raum nicht verlassen und werden automatisch hinzugefügt.
